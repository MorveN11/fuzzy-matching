...
public class Data {
    ...
    public List<Book> getBooks() {
        ...
        List<Book> books = jsonReader.parseJsonToList("lib/src/main/resources/book.json", Book.class);
        return books;
    }
    ...
    public List<User> getUsers() {
        ...
        List<User> users = jsonReader.parseJsonToList("lib/src/main/resources/users.json", User.class);
