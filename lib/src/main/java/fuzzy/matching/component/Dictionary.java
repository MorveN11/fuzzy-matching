...
/**
 * Used for Pre-Processing, the Dictionary caches a pre-defined normalization
 * and replacement for common characters
...
public class Dictionary {
  ...
  private static Map<String, String> getAddressDictionary() {
    try {
      ...
      LOGGER.error("could not load address dictionary", e);
      throw new MatchException("could not load address dictionary", e);
    }
  }
  ...
  private static Map<String, String> getNameDictionary() {
    try {
      ...
      LOGGER.error("could not load name dictionary", e);
      throw new MatchException("could not load name dictionary", e);
    }
  }
